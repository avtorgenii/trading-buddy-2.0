# Generated by Django 5.2.7 on 2025-10-06 20:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeframe', models.CharField(blank=True, default='M15', max_length=10, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('result', models.TextField(blank=True, null=True)),
                ('screenshot', models.ImageField(null=True, upload_to=trading_buddy.models.Trade.screenshot_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnl_usd', models.DecimalField(decimal_places=8, default=0, help_text='Net profit, after commissions', max_digits=20)),
                ('commission_usd', models.DecimalField(decimal_places=8, default=0, help_text='Trading fees, are always negative', max_digits=20)),
